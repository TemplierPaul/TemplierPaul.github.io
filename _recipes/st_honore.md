...
img: assets/img/recipes/st_honore/st_honore.jpg
importance: 1
category: dessert
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/recipes/st_honore/st_honore.jpeg" title="St Honoré" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
